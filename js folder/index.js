...
const editTask = (e) => {
  ...
  // const htmlC = t.outerHTML; // this gives you all code of that html

  let url = document.getElementById("imageUrl");
  let taskTitle = document.getElementById("enterTaskTitle");
...
const saveEdit = (targetId) => {
  ...
  taskContent.insertAdjacentHTML("beforeend", htmlTaskContent(updateTask));
